...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        /**
         * Array de tipus d'animals rebuts de l'API.
         * @type {Array<Object}
         */
        ...
        tipusAnimals.forEach((animal, index) => {
            ...
            `;
            console.log("nom tipus animal: "+animal.nomTipusAnimal);           
            caixaTipusAnimals.innerHTML += article;
        });        
    } catch (error) {
    // Mostra un missatge d'error si la petició falla.
    console.error("Error fetching news:", error);
    caixaTipusAnimals.innerHTML =
      "<p> Error al carregar els tipus d'animals. Si us plau, intenta-ho més tard...</p>";        
    }    
})